...
@bot.message_handler(commands=['yamusic'])
def yamusic(message):
    bot.send_message(message.chat.id,'Если не установлена Яндекс.Музыка, то <a href="https://music.yandex.ru/search">ссылка</a> откроется в браузере',  parse_mode='html')
